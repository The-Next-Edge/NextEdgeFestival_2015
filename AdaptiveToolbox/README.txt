...
3. A specific group of rules or heuristics rather than a general-purpose decision-making algorithm. These heuristics are fast, frugal, and computationally cheap, but are less consistent, coherent, and general.[3] Common examples include:[3][4]
    ...
    * Social heuristics(e.g.tit for tat, imitate-the-majority, imitate-the-successful, default heuristic, social circle heuristic,[5] averaging, choosing [6])
